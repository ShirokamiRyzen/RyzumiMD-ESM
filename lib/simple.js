    ...
    let sock = Object.defineProperties(conn, {
        ...
        getJid: {
            value(sender) {
                ...
                if (/@(s\.whatsapp\.net|g\.us|broadcast)$/.test(sender)) return sender

                // If it's a bare number, normalize it directly
                if (/^\d+$/.test(sender)) return conn.isLid[sender] = `${sender}@s.whatsapp.net`
