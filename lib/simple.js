...
/**
 * Import Baileys default socket factory and required named utilities.
 */
import baileysMakeWASocket, {
    proto,
    areJidsSameUser,
...
export function makeWASocket(connectionOptions, options = {}) {
     ...
     */
    let conn = baileysMakeWASocket(connectionOptions)
        ...
        getJid: {
            value(sender) {
                try {
                    ...
                    return conn.signalRepository.lidMapping.getPNForLID(sender)
                } catch (e) {
...
export function serialize() {
    ...
    return Object.defineProperties(proto.WebMessageInfo.prototype, {
        ...
        quoted: {
            get() {
                /**
                 * @type {ReturnType<typeof baileysMakeWASocket>}
                 */
                const self = this
                const msg = self.msg
