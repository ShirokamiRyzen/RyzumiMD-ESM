...
export function smsg(conn, m, hasParent) {
    ...
    try {
        if (protocolMessageKey && m.mtype == 'protocolMessage' && m.msg.type === 0) conn.ev.emit('message.delete', protocolMessageKey)
    } catch (e) {
        console.error(e)
    }
    return m
    ...
    return Object.defineProperties(proto.WebMessageInfo.prototype, {
        ...
        sender: {
            get() {
                ...
                const raw = (this.key?.participantAlt || this.key?.participant || this.key?.remoteJidAlt || this.chat)
